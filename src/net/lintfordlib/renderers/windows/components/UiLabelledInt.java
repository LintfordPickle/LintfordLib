...
public class UiLabelledInt extends UIWidget {
	...
	public UiLabelledInt() {
		this("Label not set");
	}

	public UiLabelledInt(String labelText) {
		mLabelText = labelText;
	}
	...
	public void draw(LintfordCore core, SharedResources sharedResources, SpriteSheetDefinition coreSpritesheetDefinition, FontUnit textFont, float componentZDepth) {
		...
		textFont.drawText(Integer.toString(mValueInt), mX + mW - lValueWidth - HorizontalPadding, mY + mH / 2 - lTextHeight / 2, componentZDepth - .01f, 1f, -1);
		textFont.end();
	}
}

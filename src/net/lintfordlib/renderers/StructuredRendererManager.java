...
public class StructuredRendererManager extends RendererManager {
	...
	/** Unloads all {@link BaseRenderer} instances registered to this {@link StructuredRendererManager} which have the given gorup ID assigned to them. */

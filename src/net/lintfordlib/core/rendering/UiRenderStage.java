...
public class UiRenderStage {
	...
	private List<UiWindow> mRenderers = new ArrayList<>();
	private List<UiWindow> mReadOnlyRenderers;

	// --------------------------------------
	// Properties
	// --------------------------------------

	public List<UiWindow> renderers() {
	...
	public UiRenderStage(String name, RenderPass pass, int stageUid) {
		this.stageName = name;
	...
	public void addRenderer(UiWindow renderer) {

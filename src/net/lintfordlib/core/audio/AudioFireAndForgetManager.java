...
public class AudioFireAndForgetManager {
	...
	/** Plays the given {@link AudioFileBase}. */
	public void play(AudioFileBase audioDataBuffer, float positionX, float positionY, float velocityX, float velocityY) {
	...
	/** Plays the given {@link AudioFileBase} at the specified volume and pitch. */
	public void play(AudioFileBase audioDataBuffer, float gain, float pitch, float positionX, float positionY, float velocityX, float velocityY) {
		if (audioDataBuffer == null || !audioDataBuffer.isLoaded())
			return;

...
public class TexturedQuad {
	...
	/**
	 * Returns the Z Depth this {@link TexturedQuad}s modelmatrix will be translated
	 * to upon request.
	 */
	public float zDepth() {
		return mZDepth;
	...
	public void setupVerts() {
		...
		GL20.glVertexAttribPointer(0, VertexDataStructurePT.positionElementCount, GL11.GL_FLOAT, false,
				VertexDataStructurePT.stride, VertexDataStructurePT.positionByteOffset);
		GL20.glVertexAttribPointer(1, VertexDataStructurePT.textureElementCount, GL11.GL_FLOAT, false,
				VertexDataStructurePT.stride, VertexDataStructurePT.textureByteOffset);

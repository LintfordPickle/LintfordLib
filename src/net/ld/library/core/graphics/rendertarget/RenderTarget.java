...
public class RenderTarget {
	...
	public void loadGLContent(int pWidth, int pHeight) {
		...
		GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, GL11.GL_RGBA, mWidth, mHeight, 0, GL11.GL_RGBA, GL11.GL_UNSIGNED_BYTE,
				BufferUtils.createByteBuffer(mWidth * mHeight * 4));
		...
		// Depth buffer
		// TODO: Extend this class to be more flexible with regard to buffer sizes (def.
		// 16-bit depth should be enough)

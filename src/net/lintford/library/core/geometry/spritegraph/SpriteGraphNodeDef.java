...
public class SpriteGraphNodeDef {
	...
	/**
	 * If this sprite node represents some object (like a steel shirt being worn on the torso), then add the object reference link here. Any object referenced here will be included as default on all
	 * {@link SpriteGraphNodeDef} instantiated from this definition file.
	 */
	...
	/** Each node references its own spritesheet (needed so characters can reference different body parts with clothing etc.) */

...
public class ParticleFrameworkData extends BaseInstanceData {
	...
	public static String PARTICLE_SYSTEM_META_FILE = "res/defs/particles/systems/_meta.json";
	public static String EMITTER_META_FILE = "res/defs/particles/emitters/_meta.json";

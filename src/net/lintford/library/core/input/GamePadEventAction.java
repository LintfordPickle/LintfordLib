...
public class GamePadEventAction implements Serializable {
	...
	public GamePadEventAction(int eventActionUid, int defaultBoundKeyCode) {
	...
	public GamePadEventAction(int eventActionUid, int defaultBoundKeyCode, int initialBoundKeyCode) {
